# infurer-lingbot-map-demos

Standalone, in-browser 3D reconstructions from LingBot-Map — self-contained
offline HTML files. Open one and orbit (or free-fly with WASD) around the point
cloud; no install, no server.

## Demos

### Pontdyk1

A ~9-minute handheld walk around the Pontdyk monument, reconstructed in windowed
mode and corrected with offline loop closure.
